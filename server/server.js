...
let deadHorses = [];
let players = {};
let cards = ["H2", "D2", "S2", "C2","H3", "D3", "S3", "C3", "H4", "D4", "S4", "C4","H5", "D5", "S5", "C5", "H6", "D6", "S6", "C6", "H7", "D7", "S7", "C7", "H8", "D8", "S8", "C8", "H9", "D9", "S9", "C9", "H10", "DT", "ST", "CT", "HJ", "DJ", "SJ", "CJ", "HQ", "DQ", "SQ", "CQ"]
...
io.on("connection", (socket) => {
  ...
  socket.on("getGameView", () => {
    io.sockets.in("game").emit('gameViewResult', {dice1, dice2, game: gameView, result: checkGameOver(), goalScore, moneyView, players});
  })
  ...
  socket.on("addPlayerFromMainScreen", (arg) => {
    addPlayer(arg);
    // TODO: check if player is in the list or not.
    io.sockets.emit("addPlayerResult", players);
